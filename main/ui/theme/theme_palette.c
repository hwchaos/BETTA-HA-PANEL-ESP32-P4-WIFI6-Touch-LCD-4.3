...
/* Pure-black AMOLED look: every background is #000000 so the panel emits no
 * light behind the tiles, while text and accents stay vivid for readability. */
static const theme_entry_t k_preset_oled = {
    .id = "oled",
    .name = "OLED Black",
    .builtin = true,
    .palette = {
        ...
        .screen_bg_grad = 0x000000,
        .content_bg = 0x000000,
        .content_border = 0x2A2A2A,
        .topbar_text = 0xFFFFFF,
        .topbar_muted = 0x9E9E9E,
        .topbar_status_on = 0x00E676,
        .topbar_status_off = 0x616161,
        .topbar_bg = 0x000000,
        .topbar_border = 0x2A2A2A,
        .topbar_chip_bg = 0x101010,
        .topbar_chip_border = 0x2A2A2A,
        .text_primary = 0xFFFFFF,
        .text_muted = 0x9E9E9E,
        .text_soft = 0xC8C8C8,
        .nav_bg = 0x000000,
        .nav_border = 0x2A2A2A,
        .nav_btn_bg_idle = 0x0A0A0A,
        .nav_btn_bg_active = 0x1F1F1F,
        .nav_tab_idle = 0x9E9E9E,
        .nav_tab_active = 0x40C4FF,
        .nav_home_idle = 0x9E9E9E,
        .nav_home_active = 0x40C4FF,
        .ok = 0x00E676,
        .error = 0xFF5252,
        .wifi_off = 0x757575,
        .card_bg_off = 0x000000,
        .card_bg_on = 0x101010,
        .card_border = 0x2A2A2A,
        .card_icon_off = 0x9E9E9E,
        .card_icon_on = 0x40C4FF,
        .state_on = 0x69F0AE,
        .state_off = 0x9E9E9E,
        .light_icon_on = 0xFFD740,
        .light_track_on = 0x3A2E00,
        .light_track_off = 0x1A1A1A,
        .light_ind_on = 0xFFD740,
        .light_ind_off = 0x757575,
        .light_knob_on = 0xFFE57F,
        .light_knob_off = 0xBDBDBD,
        .heat_icon_on = 0xFF7043,
        .heat_track_on = 0x2E1200,
        .heat_track_off = 0x1A1A1A,
        .heat_ind_on = 0xFF7043,
        .heat_ind_off = 0x757575,
        .heat_knob_on = 0xFF8A65,
        .heat_knob_off = 0xBDBDBD,
        .weather_icon = 0x40C4FF,
    },
};

/* Amber CRT / retro terminal: warm monochrome text on near-black brown. */
static const theme_entry_t k_preset_retro = {
    .id = "retro",
    .name = "Retro Amber",
    .builtin = true,
    .palette = {
        .screen_bg = 0x0A0600,
        .screen_bg_grad = 0x140C00,
        .content_bg = 0x120A00,
        .content_border = 0x5A3A00,
        .topbar_text = 0xFFB000,
        .topbar_muted = 0xB07800,
        .topbar_status_on = 0xFFC64D,
        .topbar_status_off = 0x6B4A00,
        .topbar_bg = 0x0A0600,
        .topbar_border = 0x5A3A00,
        .topbar_chip_bg = 0x1A1000,
        .topbar_chip_border = 0x5A3A00,
        .text_primary = 0xFFB000,
        .text_muted = 0xB07800,
        .text_soft = 0xD89000,
        .nav_bg = 0x0A0600,
        .nav_border = 0x5A3A00,
        .nav_btn_bg_idle = 0x1A1000,
        .nav_btn_bg_active = 0x332000,
        .nav_tab_idle = 0xB07800,
        .nav_tab_active = 0xFFB000,
        .nav_home_idle = 0xB07800,
        .nav_home_active = 0xFFB000,
        .ok = 0x8CD65B,
        .error = 0xE85B3A,
        .wifi_off = 0x6B4A00,
        .card_bg_off = 0x120A00,
        .card_bg_on = 0x241500,
        .card_border = 0x5A3A00,
        .card_icon_off = 0xB07800,
        .card_icon_on = 0xFFB000,
        .state_on = 0xFFD166,
        .state_off = 0x8A6200,
        .light_icon_on = 0xFFD166,
        .light_track_on = 0x4A3000,
        .light_track_off = 0x241500,
        .light_ind_on = 0xFFD166,
        .light_ind_off = 0x8A6200,
        .light_knob_on = 0xFFE0A0,
        .light_knob_off = 0xC09040,
        .heat_icon_on = 0xFF8A3D,
        .heat_track_on = 0x4A2000,
        .heat_track_off = 0x241500,
        .heat_ind_on = 0xFF8A3D,
        .heat_ind_off = 0x8A6200,
        .heat_knob_on = 0xFFB27A,
        .heat_knob_off = 0xC09040,
        .weather_icon = 0xFFD166,
    },
};
